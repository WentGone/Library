...
public class PickPhotoHelper {
    ...
    private HashMap<String,ArrayList<MediaModel>> mGroupMapMedia = new LinkedHashMap<>();
...
//                        mGroupMapMedia.get(PickConfig.ALL_PHOTOS).add(path);
                ...
                Iterator<Map.Entry<String, ArrayList<MediaModel>>> iterator = mGroupMapMedia.entrySet().iterator();
                while (iterator.hasNext()) {
                    Map.Entry<String, ArrayList<MediaModel>> entry = iterator.next();
                    entry.getKey();
                    ArrayList<MediaModel> value = entry.getValue();
                ...
                groupImage.mGroupMapMedia = mGroupMapMedia;
